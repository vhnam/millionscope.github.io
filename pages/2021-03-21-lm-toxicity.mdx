...
$$ \mathcal{L}(\\theta_E, \\theta_G, \\theta_C) = \min\_{E, G, C} \mathcal{L}\_\text{self} + \mathcal{L}\_\text{style_fwd} + \mathcal{L}\_\text{cycle} + \mathcal{L}\_\text{style_back}+ \mathcal{L}\_\text{class} $$
