...
![](assets/images/2022-06-09-vlm/VisualBERT-arch.png)
...
![](assets/images/2022-06-09-vlm/VisualBERT-ablation.png)
...
![](assets/images/2022-06-09-vlm/SimVLM-arch.png)
...
![](assets/images/2022-06-09-vlm/SimVLM-ablation.png)
...
![](assets/images/2022-06-09-vlm/CM3-arch.png)
...
![](assets/images/2022-06-09-vlm/Frozen-arch.png)
...
![](assets/images/2022-06-09-vlm/Frozen-results.png)
...
![](assets/images/2022-06-09-vlm/ClipCap-arch.png)
...
![](assets/images/2022-06-09-vlm/ClipCap-words.png)
...
![](assets/images/2022-06-09-vlm/VisualGPT.png)
...
$$
\begin{aligned} & B^\text{vis} \otimes \text{EncDecAttn}(H, I) + B^\text{lan} \otimes H \\
\text{where } & B^\text{vis}[i,j] = \sigma(H[i,j]) \mathbb{1}[\sigma(H[i,j]) > \tau] \\
...
![](assets/images/2022-06-09-vlm/VisualGPT-results.png)
...
![](assets/images/2022-06-09-vlm/VC-GPT.png)
Fig. 12. Illustration of VC-GPT training framework. (Image source: [Luo et al. 2022](https://arxiv.org/abs/2201.12723))
...
![](assets/images/2022-06-09-vlm/VC-GPT-results.png)
...
![](assets/images/2022-06-09-vlm/MERLOT.png)
...
- A function $$\phi \: [ 1,L ] \to [ 0,N ]$$
  is computed to track the text and image interleaving order, which assigns to each text position the index of the last image/video appearing before this position; 0 if no preceding visual data.
...
![](assets/images/2022-06-09-vlm/Flamingo-fewshot.png)
Fig. 17. Larger model sizes and more few-shot examples lead to better performance.
...
![](assets/images/2022-06-09-vlm/Flamingo-results.png)
...
![](assets/images/2022-06-09-vlm/CoCa-arch.png)
Fig. 19. Overview of CoCa training framework. (Image source: [Yu & Wang et al., 2022](https://arxiv.org/abs/2205.01917))
...
![](assets/images/2022-06-09-vlm/CoCa.png)
...
![](assets/images/2022-06-09-vlm/CoCa-code.png)
...
$$
\begin{aligned} & x_t = \arg\max_{v \in \mathcal{V}^{(k)}} \big\{ (1-\alpha) \underbrace{p(v \vert \boldsymbol{x}_{<t})}_\text{model confidence} - \alpha \underbrace{\max_{1 \leq j \leq t-1} { \text{cosine}(h_v, h_{x_j})}}_\text{degeneration penalty} + \beta \underbrace{f_\text{magic}(v \vert \mathcal{I}, \boldsymbol{x}_{<t}, \mathcal{V}^{(k)})}_\text{magic score} \big\} \\
\text{where } & f_\text{magic} ( v \vert \mathcal{I}, \mathbf{x}_{<t}, \mathcal{V}^{(k)} ) = \frac{ \exp(\text{CLIP}(\mathcal{I}, [\boldsymbol{x}_{<t}:v])) }{ \sum_{z \in \mathcal{V}^{(k)}} \exp(\text{CLIP}(\mathcal{I}, [\boldsymbol{x}_{<t}:z])) } = \frac{ \exp\big({h^\text{image}(\mathcal{I})}^\top h^\text{text}([\boldsymbol{x}_{<t}:v])\big) }{ \sum_{z \in \mathcal{V}^{(k)}} \exp\big({h^\text{image}(\mathcal{I})}^\top h^\text{text}([\boldsymbol{x}_{<t}:z])\big) } \end{aligned}
$$
...
![](assets/images/2022-06-09-vlm/MAGiC-results.png)
...
![](assets/images/2022-06-09-vlm/PICa-fewshot.png)
...
![](assets/images/2022-06-09-vlm/PICa-OKVQA.png)
...
![](assets/images/2022-06-09-vlm/SM-example.png)
...
![](assets/images/2022-06-09-vlm/SM-caption-example.png)
...
![](assets/images/2022-06-09-vlm/SM-caption.png)
...
![](assets/images/2022-06-09-vlm/SM-egocentric.png)
