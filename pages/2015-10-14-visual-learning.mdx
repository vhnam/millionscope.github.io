...
description: "Visual Information Theory"
date: 2015-10-14 12:00:00
tags: Visual Information Theory
author: Chris Olah
---

Source : Colah Blog https://colah.github.io//posts/2015-09-Visual-Information/
...
![](assets/images/2015-09-Visual-Information/prob-1D-rain.png)
...
![](assets/images/2015-09-Visual-Information/prob-1D-coat.png)
...
![](assets/images/2015-09-Visual-Information/prob-2D-independent-rain.png)
...
![](assets/images/2015-09-Visual-Information/prob-2D-dependant-rain-squish.png)
...
![](assets/images/2015-09-Visual-Information/prob-2D-factored-rain-arrow.png)
...
We're _factoring_ the distribution, breaking it down into the product of two pieces. First we look at the probability that one variable, like the weather, will take on a certain value. Then we look at the probability that another variable, like my clothing, will take on a certain value conditioned on the first variable.
...
![](assets/images/2015-09-Visual-Information/prob-2D-factored1-clothing-B.png)
...
![](assets/images/2015-09-Visual-Information/simpson-margin.png)
...
![](assets/images/2015-09-Visual-Information/simpson-participants.png)
...
![](assets/images/2015-09-Visual-Information/simpson-separated-note.png)
...
![](assets/images/2015-09-Visual-Information/message.png)

To communicate, Bob and I have to establish a code, a way of mapping words into sequences of bits.

![](assets/images/2015-09-Visual-Information/code-2bit.png)
...
![](assets/images/2015-09-Visual-Information/encode-2bit.png)
...
![](assets/images/2015-09-Visual-Information/DogWordFreq.png)
...
![](assets/images/2015-09-Visual-Information/OldCode.png)
...
![](assets/images/2015-09-Visual-Information/code.png)
...
![](assets/images/2015-09-Visual-Information/NewCode.png)
...
![](assets/images/2015-09-Visual-Information/EntropOptimalLengthExample.png)
...
![](assets/images/2015-09-Visual-Information/CodeSpace.png)
...
![](assets/images/2015-09-Visual-Information/encode.png)
...
![](assets/images/2015-09-Visual-Information/CodeSpaceUsed.png)
...
![](assets/images/2015-09-Visual-Information/code-costonly.png)
...
![](assets/images/2015-09-Visual-Information/code-lengthcontrib.png)
...
![](assets/images/2015-09-Visual-Information/code-cost.png)
...
![](assets/images/2015-09-Visual-Information/code-cost-longshort.png)
...
![](assets/images/2015-09-Visual-Information/code-auction-balanced-noderivs.png)
...
![](assets/images/2015-09-Visual-Information/code-derivs.png)
...
![](assets/images/2015-09-Visual-Information/code-auction-balanced.png)
...
Now the cost of buying a shorter codeword for $$a$$ is $$p(a) + \epsilon$$, and the cost of buying a shorter codeword for $$b$$ is $$p(b) - \epsilon$$.
But the benefits are still the same.
This leads the benefit cost ratio for buying $$a$$ to be $$\frac{p(a)}{p(a) + \epsilon}$$
which is less than one. On the other hand, the benefit cost ratio of buying $$b$$ is $$\frac{p(b)}{p(b) - \epsilon}$$ which is greater than one.

![](assets/images/2015-09-Visual-Information/code-auction-eps.png)
...
![](assets/images/2015-09-Visual-Information/entropy-def-notitle.png)
...
_(People often write entropy as $$H(p) = - \sum p(x)\log_2(p(x))$$ using the identity $$\log(1/a) = -\log(a)$$. I think the first version is more intuitive, and will continue to use it in this essay.)_
...
![](assets/images/2015-09-Visual-Information/DogCatWordFreq.png)
...
This length - the average length of communicating an event from one distribution with the optimal code for another distribution - is called the cross-entropy. Formally, we can define cross-entropy as:[4](#fn4) $$H_p(q) = \sum_x q(x)\log_2\left(\frac{1}{p(x)}\right)$$
...
![](assets/images/2015-09-Visual-Information/CrossEntropyDef.png)
...
![](assets/images/2015-09-Visual-Information/CrossEntropyCompare.png)
...
![](assets/images/2015-09-Visual-Information/CrossEntropyQP.png)
...
![](assets/images/2015-09-Visual-Information/CrossEntropyPQ.png)
...
We call this difference the Kullback-Leibler divergence, or just the KL divergence. The KL divergence of $$p$$ with respect to $$q$$, $$D_q(p)$$,[5](#fn5) is defined:[6](#fn6)
...
![](assets/images/2015-09-Visual-Information/prob-2D-factored1-detail.png)
...
![](assets/images/2015-09-Visual-Information/prob-2D-factored1-flat.png)

Now we can figure out the optimal codewords for events of these probabilities and compute the average message length:

![](assets/images/2015-09-Visual-Information/Hxy-flat.png)

We call this the joint entropy of $$X$$ and $$Y$$, defined

$$H(X,Y) = \sum\_{x,y} p(x,y) \log_2\left(\frac{1}{p(x,y)}\right)$$
...
![](assets/images/2015-09-Visual-Information/Hxy-3D.png)
...
![](assets/images/2015-09-Visual-Information/HxCy-sep.png)
...
![](assets/images/2015-09-Visual-Information/HxCy.png)

We call this the conditional entropy. If you formalize it into an equation, you get:

$$H(X|Y) = \sum\_y p(y) \sum\_x p(x|y) \log\_2\left(\frac{1}{p(x|y)}\right)$$ $$~~~~ = \sum\_{x,y} p(x,y) \log\_2\left(\frac{1}{p(x|y)}\right)$$
...
![](assets/images/2015-09-Visual-Information/Hxy-overview.png)
...
![](assets/images/2015-09-Visual-Information/Hxy-info-4.png)
...
![](assets/images/2015-09-Visual-Information/Hxy-overview-sum.png)
...
At this point, we've broken the information in $$X$$ and $$Y$$ up in several ways. We have the information in each variable, $$H(X)$$ and $$H(Y)$$. We have the the union of the information in both, $$H(X,Y)$$. We have the information which is in one but not the other, $$H(X|Y)$$ and $$H(Y|X)$$. A lot of this seems to revolve around the information shared between the variables, the intersection of their information. We call this “mutual information,” $$I(X,Y)$$, defined as:[8](#fn8) $$I(X,Y) = H(X) + H(Y) - H(X,Y)$$ This definition works because $$H(X) + H(Y)$$ has two copies of the mutual information, since it's in both $$X$$ and $$Y$$, while $$H(X,Y)$$ only has one. (Consider the previous bar diagr$$
...
![](assets/images/2015-09-Visual-Information/Hxy-info.png)
...
![](assets/images/2015-09-Visual-Information/halfbit-ab.png)
...
![](assets/images/2015-09-Visual-Information/halfbit-ab2.png)
...
![](assets/images/2015-09-Visual-Information/halfbit-ab-idealcode.png)

If we round the codeword lengths, we'll get something like this:

![](assets/images/2015-09-Visual-Information/halfbit-ab-code.png)
...
_To help me become a better writer, please consider filling out this [feedback form](https://docs.google.com/forms/d/1zaMvi-yL04GEtS7RnGplZ9TDGO5965GLlDdd50y2zNI/viewform?usp=send_form)._
...
3.  I'm cheating a little here. I've been using an exponential of base 2 where this is not true, and am going to switch to a natural exponential. This saves us having a lot of $$log(2)$$s in our proof, and makes it visually a lot nicer.[↩](#fnref3)
4.  Note that this notation for cross-entropy is non-standard. The normal notation is $$H(p,q)$$. This notation is horrible for two reasons. Firstly, the exact same notation is also used for joint entropy. Secondly, it makes it seem like cross-entropy is symmetric. This is ridiculous, and I'll be writing $$H_q(p)$$ instead.[↩](#fnref4)
5.  Also non-standard notation.[↩](#fnref5)
6.  If you expand the definition of KL divergence, you get: $$D_q(p) = \sum_x p(x)\log_2\left(\frac{p(x)}{q(x)} \right)$$ That might look a bit strange. How should we interpret it? Well, $$\log_2\left(\frac{p(x)}{q(x)} \right)$$ is just the difference between how many bits a code optimized for $$q$$ and a code optimized for $$p$$ would use to represent $$x$$. The expression as a whole is the expected difference in how many bits the two codes would use.[↩](#fnr)
...
8.  If you expand the definition of mutual information out, you get:
    ...
    $$I(X,Y) = \sum\_{x,y} p(x,y) \log_2\left(\frac{p(x,y)}{p(x)p(y)} \right)$$
    ...
    ![](assets/images/2015-09-Visual-Information/mutual-visual-eq.png)

    [↩](#fnref8)

9.  There's an entire field of quantum information theory. I know precisely nothing about the subject, but I'd bet with extremely high confidence, based on Michael's other work, that Michael Nielsen and Issac Chuang's _Quantum Computation and Quantum Information_ is an excellent introduction.[↩](#fnref9)
10. As someone who knows nothing about statistical physics, I'll very nervously try to sketch its connection to information theory as I understand it.
    ...
    If you're interested in this connection but don't want to work through the original papers, there's a section in Cover & Thomas which derives a statistical version of the Second Law of Thermodynamics from Markov Chains [↩](#fnref10)
...
11. The connection between information theory and gambling was originally laid out by John Kelly in his paper '[A New Interpretation of Information Rate](http://www.princeton.edu/~wbialek/rome/refs/kelly_56.pdf).' It's a remarkably accessible paper, although it requires a few ideas we didn't develop in this essay.
    ...
    A nice discussion of Kelly's connection between betting and information theory can be found in the standard reference on information theory, Cover & Thomas' 'Elements of Information Theory.'[↩](#fnref11)
...
12. It doesn't resolve the issue, but I can't resist offering a small further defense of KL divergence.
    ...
    Stein's Lemma says, roughly, that the amount you multiply by is controlled by the KL divergence. (There's some subtlety about the trade off between false-positives and false-negatives.) This seems like a really good reason to care about KL divergence[↩](#fnref12)
