...
description: "Convolution Neural Network : A Modular Perspective"
date: 2014-08-06 00:04:17
...
![Conv2Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv2-9x5-Conv2Conv2.png)

_A 2D Convolutional Neural Network_

<br />
This trick of having multiple copies of the same neuron is roughly analogous to the
abstraction of functions in mathematics and computer science. When programming, we
write a function once and use it in many places - not writing the same code a hundred
times in different places makes it faster to program, and results in fewer bugs.
Similarly, a convolutional neural network can learn a neuron once and use it in many
...
![Conv-9-xs](assets/images/2014-08-06-ConvNets-Modular/Conv-9-xs.png)
...
![Conv-9-F](assets/images/2014-08-06-ConvNets-Modular/Conv-9-F.png)
...
So, we can create a group of neurons, $A$, that look at small time segments of our data $A$ looks at all such segments, computing certain features.
Then, the output of this convolutional layer is fed into a fully-connected layer, $F$.

![Conv-9-Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv-9-Conv2.png)
...
![Conv-9-Conv3](assets/images/2014-08-06-ConvNets-Modular/Conv-9-Conv3.png)
...
![Conv-9-Conv2Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv-9-Conv2Conv2.png)
...
![Conv-9-Conv2Max2Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv-9-Conv2Max2Conv2.png)

<br />

![Conv2-unit](assets/images/2014-08-06-ConvNets-Modular/Conv2-unit.png)
...
![Conv2-9x5-Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv2-9x5-Conv2.png)
...
![Conv2-9x5-Conv2Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv2-9x5-Conv2Conv2.png)
...
![Conv2-9x5-Conv2Max2Conv2](assets/images/2014-08-06-ConvNets-Modular/Conv2-9x5-Conv2Max2Conv2.png)
...
![Conv-A](assets/images/2014-08-06-ConvNets-Modular/Conv-A.png)
...
![Conv-A-NIN](assets/images/2014-08-06-ConvNets-Modular/Conv-A-NIN.png)
...
It has 5 convolutional layers, with pooling interspersed, and three fully-connected layers.
The early layers are split over the two GPUs.

![KSH-arch](assets/images/2014-08-06-ConvNets-Modular/KSH-arch.png)

_<a href="http://www.cs.toronto.edu/~fritz/absps/imagenet.pdf">From Krizehvsky et al. (2012)</a>_
...
![KSH-results](assets/images/2014-08-06-ConvNets-Modular/KSH-results.png)

_Top: 4 correctly classified examples.
...
From <a href="http://www.cs.toronto.edu/~fritz/absps/imagenet.pdf">Krizehvsky et al. (2012)</a>_
...
![KSH-filters](assets/images/2014-08-06-ConvNets-Modular/KSH-filters.png)

_Filters learned by the first convolutional layer. The top half corresponds to the layer on one GPU, the bottom on the other. From <a href="http://www.cs.toronto.edu/~fritz/absps/imagenet.pdf">Krizehvsky et al. (2012)</a>_

<br />

Neurons in one side focus on black and white, learning to detect edges of different orientations and sizes.
Neurons on the other side specialize on color and texture, detecting color contrasts and patterns.
Remember that the neurons are _randomly_ initialized. No human went and set them to be edge detectors, or to split in this way. It arose simply from training the network to classify images.
...
![Conv-9-Conv2-XY](assets/images/2014-08-06-ConvNets-Modular/Conv-9-Conv2-XY.png)
...
![Conv2-5x5-Conv2-XY](assets/images/2014-08-06-ConvNets-Modular/Conv2-5x5-Conv2-XY.png)
...
There is an alternative formulation, in terms of a mathematical operation called _convolution_, that is often more helpful.
...
2. Groups of neurons, like $A$, that appear in multiple places are sometimes called modules, and networks that use them are sometimes called modular neural networks

3. Groups of neurons, like $A$, that appear in multiple places are sometimes called modules, and networks that use them are sometimes called modular neural networks

4. They also test using 7 in the paper.
