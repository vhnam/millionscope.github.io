...
$$ \begin{aligned} & Y(s, a, r, s') = r + \\gamma \max\_{a'} Q\_{\\theta^{-}}(s', a') \\ & \mathcal{L}(\\theta) = \mathbb{E}\_{(s, a, r, s') \\sim U(D)} \\Big\[ \\big( Y(s, a, r, s') - Q\_\\theta(s, a) \\big)^2 \\Big\] \end{aligned} $$
...
$$ Y_1(s, a, r, s') = r + \\gamma Q_1 (s', \arg\max\_{a' \in \mathcal{A}}Q_2(s', a'))\\ Y_2(s, a, r, s') = r + \\gamma Q_2 (s', \arg\max\_{a' \in \mathcal{A}}Q_1(s', a')) $$
...
The tensorboard graph is always helpful: ![](actor-critic-tensorboard-graph.png)
