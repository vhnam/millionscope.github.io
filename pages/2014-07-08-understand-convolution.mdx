...
description : Understand Convolution by Christopher Olah
author: Christopher Olah
tags: deep learning
---


# Understand Convolution by Christopher Olah
...
_How likely is it that a ball will go a distance $c$ if you drop it and then drop it again from above the point at which it landed?_
...
![ProbConv-fagb](assets/images/2014-07-08-understand-convolution/ProbConv-fagb.png)
...
So the probability of this happening is simply $f(a) ⋅ g(b)$.
...
![ProbConv-split-21](assets/images/2014-07-08-understand-convolution/ProbConv-split-21.png)
...
![ProbConv-splits-12-03](assets/images/2014-07-08-understand-convolution/ProbConv-splits-12-03.png)
...
Instead, we consider _all the possible ways_ of partitioning $c$ into two drops $a$ and $b$ and sum over the _probability of each way._
...
![ProbConv-OnePath](assets/images/2014-07-08-understand-convolution/ProbConv-OnePath.png)

To get the convolution, we consider all intermediate positions.

![ProbConv-SumPaths](assets/images/2014-07-08-understand-convolution/ProbConv-SumPaths.png)
...
![ProbConv-Reverse](assets/images/2014-07-08-understand-convolution/ProbConv-Reverse.png)

If we know the ball lands at a position c after the second drop, what is the probability that the previous position was $a$?

![ProbConv-BackProb](assets/images/2014-07-08-understand-convolution/ProbConv-BackProb.png)
...
![ProbConv-Intermediate](assets/images/2014-07-08-understand-convolution/ProbConv-Intermediate.png)
...
![ProbConv-Intermediate-Align](assets/images/2014-07-08-understand-convolution/ProbConv-Intermediate-Align.png)

And shrinks as the intersection between the distributions gets smaller.

![ProbConv-Intermediate-Sep](assets/images/2014-07-08-understand-convolution/ProbConv-Intermediate-Sep.png)
...
![Wiki-BoxConvAnim](assets/images/2014-07-08-understand-convolution/Wiki-BoxConvAnim.gif)
...
![ProbConv-TwoDim](assets/images/2014-07-08-understand-convolution/ProbConv-TwoDim.png)
...
![RiverTrain-ImageConvDiagram](assets/images/2014-07-08-understand-convolution/RiverTrain-ImageConvDiagram.png)

_From the <a href="http://intellabs.github.io/RiverTrail/tutorial/">River Trail documentation</a>_
...
![Gimp-Blur](assets/images/2014-07-08-understand-convolution/Gimp-Blur.png)

_Derived from the Gimp documentation_
...
![Gimp-Edge](assets/images/2014-07-08-understand-convolution/Gimp-Edge.png)
...
![Conv-9-Conv2-XY](assets/images/2014-07-08-understand-convolution/Conv-9-Conv2-XY.png)
...
The weights are the heart of the neuron, controlling its behavior.
...
![Conv-9-Conv2-XY-W](assets/images/2014-07-08-understand-convolution/Conv-9-Conv2-XY-W.png)
...
![Conv2-5x5-Conv2-XY](assets/images/2014-07-08-understand-convolution/Conv2-5x5-Conv2-XY.png)
