...
description: "An Overview of Deep Learning for Curious People"
author: Lilian Weng
date: 2017-06-21
---
...
- [How to Learn?](#how-to-learn)
  ...
  - [Blog posts mentioned](#blog-posts-mentioned)
  - [Interesting blogs worthy of checking](#interesting-blogs-worthy-of-checking)
...
![](assets/images/2017-06-21-overview/ANN.png)

Fig. 1. A three-layer artificial neural network. (Image source: [http://cs231n.github.io/convolutional-networks/#conv](http://cs231n.github.io/convolutional-networks/#conv))
...
![](assets/images/2017-06-21-overview/data_size_vs_model_performance.png)

Fig. 2. The data scale versus the model performance. (Recreated based on: [https://youtu.be/F1ka6a13S9I](https://youtu.be/F1ka6a13S9I))
...
![](assets/images/2017-06-21-overview/visual_cortex_system.png)

Fig. 3. Illustration of the human visual cortex system. (Image source: [Wang & Raj 2017](https://arxiv.org/abs/1702.07800))
...
![](assets/images/2017-06-21-overview/lenet.png)

Fig. 4. The LeNet architecture consists of two sets of convolutional, activation, and pooling layers, followed by a fully-connected layer, activation, another fully-connected layer, and finally a softmax classifier (Image source: [http://deeplearning.net/tutorial/lenet.html](http://deeplearning.net/tutorial/lenet.html))
...
![](assets/images/2017-06-21-overview/RNN.png)
...
![](assets/images/2017-06-21-overview/LSTM.png)

Fig. 6. The structure of a LSTM cell. (Image source: [http://colah.github.io/posts/2015-08-Understanding-LSTMs](http://colah.github.io/posts/2015-08-Understanding-LSTMs))
...
![](assets/images/2017-06-21-overview/rnn_shakespeare.png)

Fig. 7. A character-based recurrent neural network model writes like a Shakespeare. (Image source: [http://karpathy.github.io/2015/05/21/rnn-effectiveness](http://karpathy.github.io/2015/05/21/rnn-effectiveness))
...
![](assets/images/2017-06-21-overview/seq2seq_gmail.png)

Fig. 8. A sequence-to-sequence model for generating Gmail auto replies. (Image source: [https://research.googleblog.com/2015/11/computer-respond-to-this-email.html](https://research.googleblog.com/2015/11/computer-respond-to-this-email.html))
...
![](assets/images/2017-06-21-overview/autoencoder.png)
...
![](assets/images/2017-06-21-overview/autoencoder_experiment.png)

Fig. 10. The outputs of PCA (left) and autoencoder (right) when both try to compress documents into two numbers. (Image source: [Hinton & Salakhutdinov 2006](https://www.cs.toronto.edu/~hinton/science.pdf))
...
![](assets/images/2017-06-21-overview/alphago_paper.png) ![](assets/images/2017-06-21-overview/alphago_model.png)

Fig. 11. AlphaGo neural network training pipeline and architecture. (Image source: [Silver et al. 2016](https://www.nature.com/articles/nature16961))
...
![](assets/images/2017-06-21-overview/GAN.png)

Fig. 12. The architecture of a generative adversarial network. (Image source: [http://www.kdnuggets.com/2017/01/generative-adversarial-networks-hot-topic-machine-learning.html](http://www.kdnuggets.com/2017/01/generative-adversarial-networks-hot-topic-machine-learning.html))
...
![](assets/images/2017-06-21-overview/deep_learning_toolkits.png)
